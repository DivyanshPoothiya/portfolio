      ...
      <div className="about-container">
        ...
        <div className="about-left" ref={textStackRef}>
          ...
          <h2 className="about-header reveal-up">
            Hi, I'm <span className="about-name-accent">Divyansh</span> —
          </h2>
          ...
          <div className="about-bio-editorial reveal-mask">
            <p>
              An <strong>AI/ML Engineer</strong> with hands-on experience building practical <strong>Machine Learning and Generative AI</strong> systems. I don't just train models—I work across the full pipeline, from data preprocessing and NLP feature extraction to deploying models as accessible REST APIs.
            </p>
            <p>
              Currently focused on <strong>FastAPI</strong> backend development, intelligent automation with <strong>Selenium</strong>, and Generative AI applications — building RAG systems and LLM-powered tools. <strong>OCI Generative AI Professional</strong> certified.
            </p>
          </div>
        </div>
          ...
          <div className="portal-wrapper" ref={portalWrapperRef}>
            ...
            <div className="portal-circle">
              <img
                ...
                alt="Divyansh Poothiya Portrait Base"
            ...
            <div className="portal-overflow">
              <img
                ...
                src="/head_out_portrait.png"
                alt="Divyansh Poothiya Portrait Head"
