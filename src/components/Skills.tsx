...
const skillClusters = [
  {
    ...
    skills: ["Python (OOPs)", "Scikit-learn", "Pandas & NumPy", "Feature Engineering", "Model Evaluation"]
  },
  {
    domain: "Backend & APIs",
    image: "/skills/deploy.png",
    skills: ["FastAPI & REST APIs", "WebSockets", "SQL & PostgreSQL", "Docker", "API Integration"]
  },
  {
    domain: "Generative AI",
    image: "/skills/llm_rag.png",
    skills: ["LLM Fundamentals", "Prompt Engineering", "RAG Systems", "Oracle Cloud AI Deployment", "NLP Pipelines"]
  },
  {
    domain: "Automation & Vision",
    image: "/skills/cv.png",
    skills: ["OpenCV", "Selenium Automation", "Web Automation", "API Testing (Postman)", "MediaPipe"]
  }
];
