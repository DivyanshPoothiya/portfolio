      ...
      <div className="header-container">
        ...
        <div className="header-logo">
          <span className="logo-name">
            <span className="logo-p">D</span>
            <span ref={riyanshuRef} style={{ opacity: 0, transform: 'translateX(-10px)', display: 'inline-block' }}>ivyansh</span>
          </span>
          <span className="logo-surname" ref={surnameRef} style={{ opacity: 0, transform: 'translateX(-10px)', display: 'inline-block' }}>Poothiya</span>
        </div>
        ...
        <div className="header-right" ref={rightNavRef} style={{ opacity: 0, transform: 'translateY(-10px)' }}>
          ...
          <div className="resume-wrapper">
            ...
            <div className="resume-btn-back">
              <a href="/resume.pdf" download="divyansh_poothiya_resume.pdf" className="resume-icon-link" aria-label="Download Resume" title="Download">
