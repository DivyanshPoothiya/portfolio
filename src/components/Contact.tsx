...
import { Mail, GithubIcon, Linkedin, Download, FileText, MapPin } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 relative z-10">
        ...
        <div ref={leftColumnRef} className="w-full lg:w-1/2 flex flex-col relative z-10">
          ...
          <div className="flex flex-col gap-6 w-full max-w-md mt-12">
            {/* Email Link */}
            <a href="mailto:divyanshpoothiya123@gmail.com" className="flex items-center gap-4 group w-fit">
              ...
              <span className="text-zinc-300 group-hover:text-[#00E0C7] font-sans text-base md:text-lg transition-all tracking-wide">
                divyanshpoothiya123@gmail.com
              </span>
            </a>

            {/* Github Link */}
            <a href="https://github.com/DivyanshPoothiya" target="_blank" rel="noreferrer" className="flex items-center gap-4 group w-fit">
              <div className="w-12 h-12 flex items-center justify-center border border-white/10 group-hover:border-[#009394] group-hover:bg-[#009394]/10 transition-all text-zinc-300 group-hover:text-[#00E0C7]">
                <GithubIcon size={24} />
              </div>
              <span className="text-zinc-300 group-hover:text-[#00E0C7] font-sans text-base md:text-lg transition-all tracking-wide">
            ...
            {/* LinkedIn Link */}
            <a href="https://www.linkedin.com/in/divyansh-poothiya-98455728b/" target="_blank" rel="noreferrer" className="flex items-center gap-4 group w-fit">
              <div className="w-12 h-12 flex items-center justify-center border border-white/10 group-hover:border-[#009394] group-hover:bg-[#009394]/10 transition-all text-zinc-300 group-hover:text-[#00E0C7]">
                <Linkedin size={24} />
              </div>
              <span className="text-zinc-300 group-hover:text-[#00E0C7] font-sans text-base md:text-lg transition-all tracking-wide">
